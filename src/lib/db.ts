...
function defaultDb(): Db {
  ...
  return {
    ...
    brand_accounts: [
      ...
      { id: 'mandijoy', handle: '@mandij0y', platform: 'Instagram', status: 'active', priority: 'high', color: '#F2A65A', emoji: '✨', brand_name: 'Mandi Joy', topic: 'Personal — my real life, joy, and honest moments', bio: '✨Amanda Beck — my real life, shared with the people who already love me✨', mission: 'Be myself with the people who already know and love me. Share joy and real life — not converting anyone.', content_format: 'Personal shares — my life, joy, honest human moments', underlying_message: 'You already know me — here is my real life.', problem_message: '', solution_message: '', transformation: '', the_how: 'One honest moment at a time', tone: 'Warm, real, joyful — like talking to friends', beliefs: ['The people who already love me are enough', 'Joy is worth sharing plainly', 'The journey IS the destination'], notes: 'PERSONAL account (@mandij0y / Amanda Beck). Audience = people who already know & love me — not converting, not testing, no offers, no funnel. Inner-child / confidence / parts-work are MODALITIES I teach on YouTube + AI Mom, NEVER this account’s identity.', hooks: [] },
      ...
      { id: 'aimompodcast', handle: '@aimompodcast', platform: 'Instagram', status: 'active', priority: 'high', color: '#FF6B35', emoji: '🎙', brand_name: 'AI Mom Podcast', topic: 'How to think — not what to think — about AI. For concerned moms.', bio: 'AI for concerned moms. A podcast on how to think, not what to think, about AI.', mission: 'Help people become better witnesses in the age of AI. Attention is the product.', content_format: 'Podcast clips, audiograms, episode promos', underlying_message: 'You do not need to be told what to think about AI. You need to know how to think about it.', problem_message: 'The takes on AI are all fear or hype. A concerned mom wants a clearer way to think it through herself, not another opinion handed to her.', solution_message: 'Each episode hands you a way to THINK about AI — the questions to ask, what it reveals about us — so you reach your own conclusions.', transformation: 'From anxious and told-what-to-think → discerning and clear-eyed', the_how: 'One episode at a time', tone: 'Thoughtful, warm, unhurried — a translator with a flashlight, never a hype-man and never a doomer', beliefs: ['The goal is discernment, not adoption or rejection.', 'How you think about AI matters more than what you think about it.', 'Concerned is not the same as afraid; it is paying attention.'], hooks: [] },
...
export function readDb(): Db {
  ...
  if (db.brand_accounts) {
    ...
    if (pod && !(pod.notes ?? '').includes('CONTENT BOUNDARY')) {
      pod.notes = 'CONTENT BOUNDARY (non-negotiable): AI Mom Podcast is AI for CONCERNED moms — a show on HOW to think, not WHAT to think, about AI. NEVER productivity-guru or "AI for regular moms" framing; never "make AI simple / use AI without the overwhelm." Teach discernment and attention — never adoption, never fear. No sales asks — pure give.'
      pod.topic = 'How to think — not what to think — about AI. For concerned moms.'
      fs.writeFileSync(DB_PATH, JSON.stringify(db, null, 2))
    }
