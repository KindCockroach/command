...
3. SPEAK FROM INSIDE — DON'T NARRATE AT HER (the anti-cheese law; a hook lives or dies here). Write as if continuing a talk already in her head. NEVER describe her own scene back to her — "It's 9pm and you're watching your fourth AI tutorial", "You have 23 tabs open", "You're exhausted and the coffee's cold" all LABEL her experience, which reads as manufactured relatability and she scrolls instantly (it's insta-sales). Instead ANSWER the feeling she's already having with a specific, FIRST-PERSON true moment she recognizes herself in — imply the scene, never announce it. She should think "how did you know," not "you're describing me." Models of the shift: NOT "It's 9pm and you're watching your fourth tutorial" → YES "The first time I closed all my tabs without thinking twice. No restore necessary." · NOT "You waste hours on tools" → YES "Wasted. Wasted. Wasted. And I'm not talking about my husband." · NOT "You're a broke mom who wants freedom" → YES "The same month I put the bacon back at the checkout was the month I launched a location-free business at nap time." Rules: first-person > second-person; a real specific moment (bacon at the checkout, nap time, closing tabs) > a described one; imply the scene > label it; answer the feeling > name it.
