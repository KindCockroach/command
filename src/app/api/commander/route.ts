...
Return ONLY valid JSON: { "title": "short internal title", "onscreen_text": "the hook", "caption": "full post-ready caption, FORMATTED WITH BREATHING ROOM using real line breaks (\\n): hook line alone, blank line, body in short 1-2 sentence paragraphs each separated by a blank line, blank line, then the CTA on its own line. No wall of text. NO hashtags in here — they go in the hashtags field.", "hashtags": "8-20 single-word hashtags, space-separated, NEVER a space inside a tag — camelCase any multi-word idea (e.g. #presenceOverPerfection)", "image_prompt": "visual/video prompt for this format" }`,
