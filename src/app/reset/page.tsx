...
export const metadata: Metadata = {
  ...
  description: 'A 60-minute live reset to rewire and relax — ending with a couple of prompts that leave you as supported as the meditation leaves you satisfied. $10.',
}

// Downsell for the launch: the $10 "Reset" offered to buyers who decline the
// $55 Level Up add-on. Register button → NEXT_PUBLIC_RESET_CHECKOUT_URL.
const CHECKOUT_URL =
...
function RegisterButton() {
  return (
    <div className="cta">
      <a className="buy" href={CHECKOUT_URL}>SAVE MY SEAT — $10</a>
    ...
    <main className="rs">
      ...
      <section className="hero">
        <div className="wrap">
          ...
          <p className="sub">Not ready for the full build? Start here. Come live with me for a gentle
            reset — we&rsquo;ll slow it all down, let your nervous system exhale, and rewire the loop
            that keeps you scattered. You&rsquo;ll leave calm, clear, and quietly proud of yourself.</p>
          <RegisterButton />
        </div>
      </section>
      ...
      <section className="what">
        <div className="wrap">
          ...
          <ul className="list">
            <li><strong>Land</strong> — we drop out of the noise and back into your body. A real reset, not a to-do list.</li>
            <li><strong>Rewire</strong> — a guided practice to loosen the scattered, overwhelmed loop and let something calmer take its place.</li>
            <li><strong>Relax</strong> — you let go. As supported as a good meditation leaves you, and as satisfied with yourself as you&rsquo;ve felt in a while.</li>
            <li><strong>A couple of prompts</strong> — you leave with two prompts to carry the calm forward and hear what you actually want to say.</li>
          </ul>
        </div>
      </section>
      ...
      <section className="band">
        <div className="wrap">
          ...
          <p>The woman with a hundred open tabs in her head who just needs to exhale first. This is the
            gentlest way in — one hour, ten dollars, and a reset you&rsquo;ll want to come back to. When
            you&rsquo;re ready to build, Caption Writer and the Level Up are waiting.</p>
        </div>
      </section>

      <section className="final">
        <div className="wrap">
          <h2>One hour. One exhale. Ten dollars.</h2>
          <RegisterButton />
        </div>
      </section>
    </main>
